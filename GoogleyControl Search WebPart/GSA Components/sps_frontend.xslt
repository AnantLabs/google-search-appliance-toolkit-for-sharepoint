...
<xsl:variable name="choose_bottom_navigation"></xsl:variable>
...
<xsl:template match="R">
  ...
  <xsl:if test="$show_res_title != '0'">
    ...
    <xsl:choose>
      ...
      <xsl:when test="@MIME='text/plain'"><img src="images/iclog.gif" alt="Text Doc"></img></xsl:when>
      <xsl:when test="@MIME='application/rtf'"><img src="images/icrtf.gif" alt="Richtext Doc"></img></xsl:when>
      <xsl:when test="@MIME='application/pdf'"><img src="images/icpdf.gif" alt="PDF"></img></xsl:when>
      <xsl:when test="@MIME='application/postscript'">[PS]</xsl:when>
      <xsl:when test="@MIME='application/vnd.ms-powerpoint'"><img src="images/icpot.gif" alt="MS Powerpoint"></img></xsl:when>
      <xsl:when test="@MIME='application/vnd.ms-excel'"><img src="images/icxls.gif" alt="MS Excel"></img></xsl:when>
      <xsl:when test="@MIME='application/msword'"><img src="images/icdoc.gif" alt="MS Word"></img></xsl:when>
      <xsl:otherwise>
